...
public class MapInfosPresenter implements MapInfosContract.UserActionListener {
    ...
    public void loadLocationInfos(boolean forceUpdate) {
        ...
        dummyDatas.add(new ReviewData(3, "숭실대학교", "서울특별시 동작구 상도동 127-7", new LatLng(37.4962518, 126.9573151), "#학교 #고통받는장소", "우리학교에요!", "졸업하고싶어요..", "다시 가고 싶진 않을듯", "010-2343-2323"));
        dummyDatas.add(new ReviewData(4, "노량진 수산시장", "서울특별시 동작구 상도동 128-7", new LatLng(37.5153631, 126.9408988), "#음식점 #", "횟값이 싸요", "냄새가 비려요", "다시 가고 싶진 않을듯", "010-2343-2323"));
        dummyDatas.add(new ReviewData(5, "공단기고시학원", "서울특별시 동작구 상도동 125-7", new LatLng(37.5122912, 126.9509761), "#낭만 #추억", "여기서 인생 대박낼꺼에요", "5년째 여기서 살고있어", "다시 가고 싶진 않을듯", "010-2343-2323"));
